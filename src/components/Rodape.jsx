    ...
    return (
        ...
        <footer className="menu absolute w-full z-10">
            <div className='container max-w-4xl mx-auto py-2'>
                ...
                <a href="https://www.linkedin.com/in/jpradoweb/"><p className='text-sm text-white text-center my-2 md:my-0 cursor-pointer animacaoToque'><i>Desenvolvido por @jpradoweb</i> </p></a>
            </div>
        </footer>
